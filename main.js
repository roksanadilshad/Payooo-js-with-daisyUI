...
function toggleHandlerBtn(id){
  const formBtns = document.getElementsByClassName('form-btn ');
   ...
   document.getElementById(id).classList.remove('border-[#0808081c]');
